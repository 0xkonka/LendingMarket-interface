import { getAssetInfoFactory, TokenIcon as DefaultTokenIcon, TokenIconProps } from 'aave-ui-kit';
...
export const TokenIcon = (props: Omit<TokenIconProps, 'getAssetInfo'>) => (
  <DefaultTokenIcon {...props} getAssetInfo={getAssetInfo} style={{ fontWeight: 'normal' }} />
);
