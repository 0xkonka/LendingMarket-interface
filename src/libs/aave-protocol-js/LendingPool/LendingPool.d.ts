...
export interface LendingPoolInterface extends utils.Interface {
  functions: {
    ...
    'depositWithAutoDLP(address,uint256,address,uint16)': FunctionFragment;
    ...
    'setLeverager(address)': FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: 'depositWithAutoDLP',
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<string>,
  ...
  encodeFunctionData(functionFragment: 'setLeverager', values: [PromiseOrValue<string>]): string;
  ...
  decodeFunctionResult(functionFragment: 'depositWithAutoDLP', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'setLeverager', data: BytesLike): Result;
...
export interface LendingPool extends BaseContract {
  ...
  functions: {
    ...
    leverager(overrides?: CallOverrides): Promise<[string]>;
    ...
    setLeverager(
      _leverager: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    setLeverager(_leverager: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    leverager(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    leverager(overrides?: CallOverrides): Promise<PopulatedTransaction>;
