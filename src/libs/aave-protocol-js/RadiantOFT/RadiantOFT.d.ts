...
export interface RadiantOFTInterface extends utils.Interface {
  functions: {
    ...
    'getBridgeFee(uint256)': FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: 'getBridgeFee', data: BytesLike): Result;
...
export type PriceProviderUpdatedEvent = TypedEvent<[string], PriceProviderUpdatedEventObject>;

export type PriceProviderUpdatedEventFilter = TypedEventFilter<PriceProviderUpdatedEvent>;
...
export interface RadiantOFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RadiantOFTInterface;
  ...
  functions: {
    ...
    getBridgeFee(
      rdntAmount: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
  ...
  filters: {
    ...
    'FeeUpdated(uint256)'(_fee?: null): FeeUpdatedEventFilter;
    FeeUpdated(_fee?: null): FeeUpdatedEventFilter;
    ...
    'PriceProviderUpdated(address)'(
      _priceProvider?: PromiseOrValue<string> | null
