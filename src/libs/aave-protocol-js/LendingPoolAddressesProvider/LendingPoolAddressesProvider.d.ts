...
export interface LendingPoolAddressesProviderInterface extends utils.Interface {
  functions: {
    ...
    'getLiquidationFeeTo()': FunctionFragment;
    ...
    'setLiquidationFeeTo(address)': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'getLiquidationFeeTo', values?: undefined): string;
  ...
  encodeFunctionData(
    functionFragment: 'setLiquidationFeeTo',
    values: [PromiseOrValue<string>]
  ): string;
  ...
  decodeFunctionResult(functionFragment: 'getLiquidationFeeTo', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'setLiquidationFeeTo', data: BytesLike): Result;
...
export type PriceOracleUpdatedEvent = TypedEvent<[string], PriceOracleUpdatedEventObject>;
...
export interface LendingPoolAddressesProvider extends BaseContract {
  ...
  functions: {
    ...
    getLiquidationFeeTo(overrides?: CallOverrides): Promise<[string]>;
    ...
    setLiquidationFeeTo(
      liquidationFeeTo: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    getLiquidationFeeTo(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getLiquidationFeeTo(overrides?: CallOverrides): Promise<PopulatedTransaction>;
