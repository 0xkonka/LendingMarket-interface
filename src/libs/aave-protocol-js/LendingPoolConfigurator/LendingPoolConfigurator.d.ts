...
export interface LendingPoolConfiguratorInterface extends utils.Interface {
  functions: {
    ...
    'batchInitReserve((address,address,address,uint8,address,address,address,address,uint256,string,string,string,string,string,string,string,bytes)[])': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'activateReserve', values: [PromiseOrValue<string>]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: 'freezeReserve', values: [PromiseOrValue<string>]): string;
  ...
  encodeFunctionData(functionFragment: 'unfreezeReserve', values: [PromiseOrValue<string>]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'batchInitReserve', data: BytesLike): Result;
...
export type ATokenUpgradedEvent = TypedEvent<[string, string, string], ATokenUpgradedEventObject>;
...
export type ReserveActivatedEvent = TypedEvent<[string], ReserveActivatedEventObject>;
...
export type ReserveDeactivatedEvent = TypedEvent<[string], ReserveDeactivatedEventObject>;
...
export type ReserveUnfrozenEvent = TypedEvent<[string], ReserveUnfrozenEventObject>;
...
export interface LendingPoolConfigurator extends BaseContract {
  ...
  callStatic: {
    activateReserve(asset: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
    ...
    deactivateReserve(asset: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
    ...
    freezeReserve(asset: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
    ...
    unfreezeReserve(asset: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    'ReserveActivated(address)'(asset?: PromiseOrValue<string> | null): ReserveActivatedEventFilter;
    ReserveActivated(asset?: PromiseOrValue<string> | null): ReserveActivatedEventFilter;

    'ReserveDeactivated(address)'(
      asset?: PromiseOrValue<string> | null
    ): ReserveDeactivatedEventFilter;
    ReserveDeactivated(asset?: PromiseOrValue<string> | null): ReserveDeactivatedEventFilter;
    ...
    'ReserveFrozen(address)'(asset?: PromiseOrValue<string> | null): ReserveFrozenEventFilter;
    ReserveFrozen(asset?: PromiseOrValue<string> | null): ReserveFrozenEventFilter;
    ...
    'ReserveUnfrozen(address)'(asset?: PromiseOrValue<string> | null): ReserveUnfrozenEventFilter;
    ReserveUnfrozen(asset?: PromiseOrValue<string> | null): ReserveUnfrozenEventFilter;
