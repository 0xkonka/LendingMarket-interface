...
import introspectionQueryResultData from 'libs/subgraph-provider/fragmentTypes.json';
import {
  GET_MAINNET_CACHED_SERVER_WS_ERROR,
  GET_NETWORK_CACHED_SERVER_WS_ERROR,
  GET_QUERY_ERROR,
  WsErrorCountKey,
} from 'libs/pool-data-provider/hooks/use-graph-check';
...
export function getApolloClient({
  ...
  const poolTheGraphLink = new HttpLink({
    uri: protocolDataUrl,
    fetchOptions: {
      mode: 'cors',
    },
