...
const Icon = ({ height = 23, width = 20, color = '#f3ba2f', className }: IconProps) => {
  return (
    ...
    >
      ...
      <path
        fill="#fff"
        d="M404.9 556L512 663.1l107.1-107.2 62.4 62.3h-.1L512 787.7 342.6 618.3l-.1-.1z"
      />
      <path
      ...
      <path
        fill="#fff"
        d="M575.2 512L512 448.7l-46.7 46.8-5.4 5.3-11.1 11.1-.1.1.1.1 63.2 63.2 63.2-63.3z"
      />
    </svg>
  );
};
